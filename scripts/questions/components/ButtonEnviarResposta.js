...
function generateButtonEnviarResposta(question, variant) {
  ...
  let classesButton =
    "h-12 rounded-sm border z-10 font-semibold px-14 disabled:cursor-not-allowed";
  if (variant === "primary") {
    classesButton += " border-primary-900 text-primary-900 bg-gray-200";
  } else {
    classesButton +=
      " border-secondary-500 text-secondary-500 bg-secondary-900 disabled:text-secondary-overlay-200 rounded-md disabled:border-secondary-overlay-200 disabled:bg-secondary-overlay-800";
  }
...
export { generateButtonEnviarResposta };
