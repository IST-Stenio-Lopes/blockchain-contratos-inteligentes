...
const UE6Q2 = {
  ...
  classifications: {
    "O limite máximo que você está disposto gastar com uma operação.":
      "Limite de gás",
    "Quantidade mínima de gás que a blockchain Ethereum precisa para processar a transação naquele instante":
      "Taxa base",
    "Taxa adicional feita para que sua operação seja concluída rapidamente.":
      "Gorjeta",
  },
...
const UE6Q4 = {
  ...
  assessments: [
    {
      sentence:
        "Os contratos inteligentes utilizam <input /> como plataforma para seu funcionamento.",
      ...
      evaluation: {
        feedback: {
          correct: {
            title: "PARABÉNS!",
            subtitle:
              "Os desenvolvedores desenvolvem e carregam programas para serem armazenados e compilados na EVM.",
          },
          incorrect: {
            title: "OPS!",
...
const UE6Q5 = {
  uid: "UE6Q5",
  assertive:
    "Relacione corretamente as características de cada algoritmo de validação abaixo:",
  components: [],
  allowMultipleSelect: true,
  descriptions: ["Características", "Algoritmo de validação"],
  classifications: {
    "O poder computacional é utilizado resolvendo um problema matemático para minerar um bloco.":
      "Proof of work ou prova de trabalho",
    "Alto custo relacionado a energia elétrica e hardware especializado.":
      "Proof of work ou prova de trabalho",
    "A chance de cada validador construir o bloco é proporcional à quantidade de criptomoedas na aposta.":
      "Proof of stake ou prova de participação",
    "Solução mais ecológica e rápida, pois não envolve uso de hardware especializado e algot consumo de energia elétrica":
      "Proof of stake ou prova de participação",
  },
  alternatives: [
    "Proof of work ou prova de trabalho",
  ...
  correctFeedback: {
    title: "PARABÉNS!",
    subtitle:
      "Você identificou as características da prova de trabalho e a descrição de gorjeta.",
  },
  incorrectFeedback: {
    title: "OPS!",
    subtitle: "Revisite os conceitos da unidade.",
...
const UE6Q6 = {
  ...
  assessments: [
    {
      sentence:
        "Parte do funcionamento Proof of Stake ou prova de participação consiste que o participante tenha uma quantidade de criptomoedas bloqueadas na “apostadas” em um bloco. <input />",
      alternatives: ["Blockchain", "EVM", "Proof of Stake"],
      correctAnswer: ["EVM"],
      evaluation: {
        feedback: {
